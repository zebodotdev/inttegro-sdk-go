...
func (s *Service) Create(ctx context.Context, params CreateParams, opts ...request.Option) (*UploadRequest, error) {
	var resp struct {
...
func (s *Service) Lookup(ctx context.Context, id string) (*UploadRequest, error) {
	var resp struct {
		UploadRequest UploadRequest `json:"upload_request"`
	}
...
func (s *Service) Cancel(ctx context.Context, params CancelParams, opts ...request.Option) (*UploadRequest, error) {
	var resp struct {
		UploadRequest UploadRequest `json:"upload_request"`
	}
...
func (s *Service) Review(ctx context.Context, params ReviewParams, opts ...request.Option) (*UploadRequest, error) {
	var resp struct {
		UploadRequest UploadRequest `json:"upload_request"`
	}
...
func (s *Service) Fulfill(ctx context.Context, params FulfillParams) (*UploadRequest, *file.File, error) {
